...
final getBodyDataUseCaseProvider =
    AutoDisposeProvider<GetBodyDataUseCase>.internal(
  getBodyDataUseCase,
  name: r'getBodyDataUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getBodyDataUseCaseHash,
  dependencies: null,
...
final saveBodyDataUseCaseProvider =
    AutoDisposeProvider<SaveBodyDataUseCase>.internal(
  saveBodyDataUseCase,
  name: r'saveBodyDataUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$saveBodyDataUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
